...
class TrackingHistory
{
    public:
        ...
        void draw(int width)
        {
            ...
            // Draw the Centre X
            ofSetColor(ofColor::yellow);
            ofDrawLine(float(width*0.5),_startposy-5,float(width*0.5),_startposy+5);

            // Draw Min Size Guide
            ofSetColor(ofColor::cyan);
            ofDrawLine((float(width*0.5))-(_minsize/2),_startposy-10,(float(width*0.5))-(_minsize/2),_startposy+10);
            ofDrawLine((float(width*0.5))+(_minsize/2),_startposy-10,(float(width*0.5))+(_minsize/2),_startposy+10);

            // Draw Mid Size Guide
            ofSetColor(ofColor::purple);
            ofDrawLine((float(width*0.5))-(_midsize/2),_startposy-10,(float(width*0.5))-(_midsize/2),_startposy+10);
            ofDrawLine((float(width*0.5))+(_midsize/2),_startposy-10,(float(width*0.5))+(_midsize/2),_startposy+10);

            // Draw Max Size Guide
            ofSetColor(ofColor::limeGreen);
            ofDrawLine((float(width*0.5))-(_maxsize/2),_startposy-10,(float(width*0.5))-(_maxsize/2),_startposy+10);
            ofDrawLine((float(width*0.5))+(_maxsize/2),_startposy-10,(float(width*0.5))+(_maxsize/2),_startposy+10);
            ofPopStyle();
            ...
            for (int i = 0; i < division; i++)
            {
                ...
                ofDrawLine((float(width*0.5))-(((1+i)*50)/2),_startposy-5,(float(width*0.5))-(((1+i)*50)/2),_startposy+5);
                ofDrawLine((float(width*0.5))+(((1+i)*50)/2),_startposy-5,(float(width*0.5))+(((1+i)*50)/2),_startposy+5);
            }

            ofPushStyle();
            ofSetLineWidth(2);
            for(unsigned long i = 0; i < trackingHistory.size(); i++)
            {
                ...
                ofDrawLine((float(width*0.5))-(trackingHistory[i].size/2),(unsigned long)_startposy+(i*5),(float(width*0.5))+(trackingHistory[i].size/2),(unsigned long)_startposy+(i*5));
            }
            ofPopStyle();
        }
